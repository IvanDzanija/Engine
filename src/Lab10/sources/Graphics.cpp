...
namespace eng {
void (*Graphics::_mouse_callback_user)(GLFWwindow *, int32, int32, int32) = nullptr;
...
int32 Graphics::register_mouse_click_method(void (*mouse_callback_user)(GLFWwindow *,
                                                                        int32, int32,
                                                                        int32)) {
...
void Graphics::_mouse_button_callback(GLFWwindow *window, int32 button, int32 action,
  ...
  if (_mouse_callback_user != nullptr) {
    (*_mouse_callback_user)(window, button, action, mods);
  }
}
