...
class Grafika {
 ...
 public:
  // konstruktor sa sirinom i visinom prozora, bojom kojom se brise prozor i put do
  // programa
  ...
  // osvjetli fragment rastera na koordinatama x i y, gdje je ishodiste u donjem lijevom
  // kutu
